...
public class SharedElementDelayingChangeHandler extends ArcFadeMoveChangeHandler {
    ...
    public SharedElementDelayingChangeHandler(String name) {
        waitForTransitionNames = new ArrayList<>();
    ...
    @Override
    public void prepareForTransition(@NonNull final ViewGroup container, @Nullable View from, @Nullable final View to, @NonNull Transition transition, boolean isPush, @NonNull
    final TransitionChangeHandler.OnTransitionPreparedListener onTransitionPreparedListener) {
